...
/**
 * Maps the shaka locales to Black Tube's active ones
 * This allows us to know which locale files are actually needed
 * and which shaka locale needs to be activated for a given Black Tube one.
...
function getMappings(shakaLocales, freeTubeLocales) {
   ...
   * The first element is the Black Tube locale, the second one is the shaka-player one
   */
  const mappings = []
  ...
  mappings.push(
    ...
    // not sure why we have pt, pt-PT and pt-BR in the Black Tube locales
