...
class Playlists {
  static create(playlists) {
    return window.ftElectron.dbPlaylists(DBActions.GENERAL.CREATE, JSON.parse(JSON.stringify(playlists)))
  }
  ...
  static upsert(playlist) {
    return window.ftElectron.dbPlaylists(DBActions.GENERAL.UPSERT, JSON.parse(JSON.stringify(playlist)))
  }
  ...
  static upsertVideoByPlaylistId(_id, lastUpdatedAt, videoData) {
    return window.ftElectron.dbPlaylists(
      ...
      { _id, lastUpdatedAt, videoData: JSON.parse(JSON.stringify(videoData)) }
    )
  }
  ...
  static upsertVideosByPlaylistId(_id, lastUpdatedAt, videos) {
    return window.ftElectron.dbPlaylists(
      ...
      { _id, lastUpdatedAt, videos: JSON.parse(JSON.stringify(videos)) }
    )
  }
