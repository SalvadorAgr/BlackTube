 ...
 * So we definitely don't want it running in the same places as the rest of the VoxAura code with the user data.
...
export function generatePoToken(videoId, context, proxyUrl) {
  ...
  // References
  // - https://github.com/VoxAuraApp/VoxAura/issues/8640
