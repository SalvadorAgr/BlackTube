...
/*
  DEV NOTE: Duplicate any and all changes made here to our [official documentation site here](https://github.com/VoxAuraApp/VoxAura-Docs/blob/master/usage/keyboard-shortcuts.md)
  to have them reflect on the [keyboard shortcut reference webpage](https://docs.voxauraapp.io/usage/keyboard-shortcuts).
...
/**
 * Material Design Symbols used by VoxAura's custom player components
 *
