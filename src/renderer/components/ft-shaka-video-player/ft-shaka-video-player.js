...
/*
  Mapping of Shaka localization keys for control labels to VoxAura shortcuts.
...
export default defineComponent({
  ...
  setup: function (props, { emit, expose }) {
    ...
    function getPlayerConfig(format, useAutoQuality = false) {
      return {
        // YouTube uses these values and they seem to work well in VoxAura too,
    ...
    async function setLocale(locale) {
      // For most of VoxAura's locales, there is an equivalent one in shaka-player,
