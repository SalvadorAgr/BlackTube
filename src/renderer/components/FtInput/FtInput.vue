  ...
  >
    ...
    <span class="inputWrapper">
      ...
      >
        <LucideIcon
          class="buttonIcon"
          :name="Array.isArray(actionButtonIconName) ? actionButtonIconName[1] : actionButtonIconName"
        />
      </button>
    </span>
    <div class="options">
        ...
        >
          <div class="optionWrapper">
            <LucideIcon
              ...
              :name="dataListProperties[index].iconName"
...
const actionButtonIconName = shallowRef(props.forceActionButtonIconName ?? 'search')
...
async function handleActionIconChange() {
  ...
  if (!inputDataPresent.value && props.forceActionButtonIconName === null) {
    ...
    actionButtonIconName.value = 'search'
    return
  }
  ...
  try {
    ...
    if (props.forceActionButtonIconName === null) {
      if (isYoutubeLink) {
        ...
        actionButtonIconName.value = 'arrow-right'
      } else {
        // Search with text
        actionButtonIconName.value = 'search'
      }
