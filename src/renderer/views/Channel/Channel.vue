    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <LucideIcon name="search" :size="18" /> {{ $t("Search Filters.Fetch more results") }}
          </div>
        </FtAutoLoadNextPageWrapper>
      </div>
    </FtCard>
...
async function getChannelLocal() {
  ...
  try {
    ...
    if (channelInstance.alert) {
      ...
      setErrorMessage(t('Channel["This channel is age-restricted and currently cannot be viewed in VoxAura."]'), true)
      return
    }
